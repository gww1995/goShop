...
func main() {
	dsn := "root:root@tcp(192.168.1.23:3306)/goods_test?charset=utf8mb4&parseTime=True&loc=Local"
...
func Mysql2Es() {
	dsn := "root:root@tcp(192.168.1.23:3306)/goshop_srv_goods?charset=utf8mb4&parseTime=True&loc=Local"
